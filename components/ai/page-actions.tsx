    ...
    <button
      ...
      className={cn(
        buttonVariants({
          ...
          size: "sm",
          className:
            "[&_svg]:text-fd-muted-foregroundn gap-2 rounded-full border-none bg-gray-100 px-3 [&_svg]:size-3.5",
        }),
      )}
      onClick={onClick}
    >
...
export function ViewOptions({
  ...
  /**
   * Custom trigger element. Falls back to the default "Open" button.
   */
  trigger?: ReactNode;
}) {
  const items = useMemo(() => {
