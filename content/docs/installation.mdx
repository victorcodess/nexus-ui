...
Available components: `prompt-input`, `suggestions`, `model-selector`, `attachments`, `message`, `thread`, `citation`, `reasoning`, `text-shimmer`, `image`, `feedback-bar`, `toaster`, `chain-of-thought`.
