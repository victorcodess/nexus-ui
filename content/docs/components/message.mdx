...
<Tab value="npm">
```bash
npx shadcn@latest add button avatar && npm install streamdown @streamdown/cjk @streamdown/code @streamdown/math @streamdown/mermaid radix-ui @radix-ui/react-slot @hugeicons/react @hugeicons/core-free-icons hast
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx shadcn@latest add button avatar && pnpm add streamdown @streamdown/cjk @streamdown/code @streamdown/math @streamdown/mermaid radix-ui @radix-ui/react-slot @hugeicons/react @hugeicons/core-free-icons hast
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx shadcn@latest add button avatar && yarn add streamdown @streamdown/cjk @streamdown/code @streamdown/math @streamdown/mermaid radix-ui @radix-ui/react-slot @hugeicons/react @hugeicons/core-free-icons hast
```
</Tab>
<Tab value="bun">
```bash
bunx shadcn@latest add button avatar && bun add streamdown @streamdown/cjk @streamdown/code @streamdown/math @streamdown/mermaid radix-ui @radix-ui/react-slot @hugeicons/react @hugeicons/core-free-icons hast
```
</Tab>
</Tabs>
</Step>
...
<ComponentSource src="registry/new-york/message/codeblock.tsx" title="components/nexus-ui/codeblock.tsx" />
</Step>
<Step>
