...
<Tab value="npm">
```bash
npx shadcn@latest add textarea scroll-area && npm install @radix-ui/react-slot
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx shadcn@latest add textarea scroll-area && pnpm add @radix-ui/react-slot
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx shadcn@latest add textarea scroll-area && yarn add @radix-ui/react-slot
```
</Tab>
<Tab value="bun">
```bash
bunx shadcn@latest add textarea scroll-area && bun add @radix-ui/react-slot
```
</Tab>
</Tabs>
</Step>
