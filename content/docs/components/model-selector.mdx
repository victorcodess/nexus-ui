    ...
    <Steps>
      <Step>
        ...
        <Tabs items={["npm", "pnpm", "yarn", "bun"]}>
          <Tab value="npm">
            ```bash
            npx shadcn@latest add @nexus-ui/nexus-ui-theme && npm install radix-ui class-variance-authority @hugeicons/react @hugeicons/core-free-icons
            ```
          </Tab>
          <Tab value="pnpm">
            ```bash
            pnpm dlx shadcn@latest add @nexus-ui/nexus-ui-theme && pnpm add radix-ui class-variance-authority @hugeicons/react @hugeicons/core-free-icons
            ```
          </Tab>
          <Tab value="yarn">
            ```bash
            yarn dlx shadcn@latest add @nexus-ui/nexus-ui-theme && yarn add radix-ui class-variance-authority @hugeicons/react @hugeicons/core-free-icons
            ```
          </Tab>
          <Tab value="bun">
            ```bash
            bunx shadcn@latest add @nexus-ui/nexus-ui-theme && bun add radix-ui class-variance-authority @hugeicons/react @hugeicons/core-free-icons
            ```
          </Tab>
        </Tabs>
      </Step>
