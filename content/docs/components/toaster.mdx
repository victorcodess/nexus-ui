...
import ToasterWithDescriptionAction from "@/components/nexus-ui/examples/toaster/with-description-action";
...
<DemoWithCode src="components/nexus-ui/examples/toaster/with-description-action.tsx">
  <ToasterWithDescriptionAction />
</DemoWithCode>
