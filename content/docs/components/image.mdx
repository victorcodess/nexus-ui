---
title: Image
description: Composable AI image renderer for base64 and Uint8Array payloads
---
...
Composable image primitives for multimodal chat UIs. `Image` accepts AI-generated payloads (`base64` or `uint8Array`) and exposes `ImagePreview`, `ImageLoader`, and optional action slots.
...
<TypeTable
  type={{
    ...
    uint8Array: {
      type: "Uint8Array",
      description:
        "Binary image payload used when `base64` is not provided.",
    },
    mediaType: {
      type: "string",
      default: '"image/png"',
...
<TypeTable
  type={{
    forceVisible: {
      ...
      default: "false",
      description:
        "Forces visible loader style in empty-source states.",
    },
    className: {
      type: "string",
