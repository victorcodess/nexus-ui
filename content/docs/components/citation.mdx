...
<Tab value="npm">
```bash
npx shadcn@latest add @nexus-ui/nexus-ui-theme carousel hover-card && npm install radix-ui @hugeicons/react @hugeicons/core-free-icons tldts
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx shadcn@latest add @nexus-ui/nexus-ui-theme carousel hover-card && pnpm add radix-ui @hugeicons/react @hugeicons/core-free-icons tldts
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx shadcn@latest add @nexus-ui/nexus-ui-theme carousel hover-card && yarn add radix-ui @hugeicons/react @hugeicons/core-free-icons tldts
```
</Tab>
<Tab value="bun">
```bash
bunx shadcn@latest add @nexus-ui/nexus-ui-theme carousel hover-card && bun add radix-ui @hugeicons/react @hugeicons/core-free-icons tldts
```
</Tab>
</Tabs>
</Step>
