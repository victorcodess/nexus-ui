...
<Tab value="npm">
```bash
npx shadcn@latest add @nexus-ui/nexus-ui-theme button && npm install @radix-ui/react-presence @radix-ui/react-slot class-variance-authority
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx shadcn@latest add @nexus-ui/nexus-ui-theme button && pnpm add @radix-ui/react-presence @radix-ui/react-slot class-variance-authority
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx shadcn@latest add @nexus-ui/nexus-ui-theme button && yarn add @radix-ui/react-presence @radix-ui/react-slot class-variance-authority
```
</Tab>
<Tab value="bun">
```bash
bunx shadcn@latest add @nexus-ui/nexus-ui-theme button && bun add @radix-ui/react-presence @radix-ui/react-slot class-variance-authority
```
</Tab>
</Tabs>
</Step>
