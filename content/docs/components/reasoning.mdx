---
title: Reasoning
description: Collapsible model reasoning trace with streaming-aware labels and markdown body
---
...
<Step>
<h3>Render assistant reasoning parts with <code className="tracking-0!">Reasoning</code></h3>
