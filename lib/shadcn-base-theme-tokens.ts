/**
 * Light / dark semantic tokens per shadcn base palette (shadcn-ui v4 registry).
 * Applied on document.documentElement via inline styles on the theme demo.
 */

export type ShadcnBaseThemeId = "neutral" | "stone" | "zinc" | "mauve" | "olive" | "mist" | "taupe";

export const SHADCN_BASE_THEME_LIGHT_VARS: Record<ShadcnBaseThemeId, Record<string, string>> = {
  "neutral": {
    ...
    "--scrollbar-thumb": "color-mix(in oklch, var(--muted-foreground) 45%, var(--background))",
    "--scrollbar-thumb-hover": "color-mix(in oklch, var(--muted-foreground) 65%, var(--background))"
  },
  "stone": {
    "--background": "oklch(1 0 0)",
...
export const SHADCN_BASE_THEME_DARK_VARS: Record<ShadcnBaseThemeId, Record<string, string>> = {
  "neutral": {
